          ...
          <tbody>
            <tr>
              <td valign="top">
                ...
                <table bgcolor="#FFFF88" border="0" cellspacing="0" cellpadding="5" width="200">
                  <tbody>
                      ...
                      <td>
                        <c:if test="${!empty accountForm.account}">
                          <b><i><font size="2" color="BLACK">
                            Welcome <c:out value="${accountForm.account.firstname}"/>!
                          </font></i></b>
                        </c:if>
                        &nbsp;
                      </td>
                    ...
                    <tr>
                      <td>
                        <a href="<c:url value="/shop/viewCategory.do?categoryName=FISH"/>">
                        <img border="0" src="../images/fish_icon.gif" /></a>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <a href="<c:url value="/shop/viewCategory.do?categoryName=DOGS"/>">
                        <img border="0" src="../images/dogs_icon.gif" /></a>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <a href="<c:url value="/shop/viewCategory.do?categoryName=CATS"/>">
                        <img border="0" src="../images/cats_icon.gif" /></a>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <a href="<c:url value="/shop/viewCategory.do?categoryName=REPTILES"/>">
                        <img border="0" src="../images/reptiles_icon.gif" /></a>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <a href="<c:url value="/shop/viewCategory.do?categoryName=BIRDS"/>">
              ...
              <td align="center" bgcolor="white" height="300" width="100%">
                ...
                <map name="estoremap">
                  <area alt="Birds" coords="72,2,280,250" href="viewCategory.do?categoryName=BIRDS" shape="RECT" />
                  <area alt="Fish" coords="2,180,72,250" href="viewCategory.do?categoryName=FISH" shape="RECT" />
                  <area alt="Dogs" coords="60,250,130,320" href="viewCategory.do?categoryName=DOGS" shape="RECT" />
                  <area alt="Reptiles" coords="140,270,210,340" href="viewCategory.do?categoryName=REPTILES" shape="RECT" />
