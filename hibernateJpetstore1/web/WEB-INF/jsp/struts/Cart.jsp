  ...
  <tr><td valign="top" width="20%" align="left">
      <table align="left" bgcolor="#008800" border="0" cellspacing="2" cellpadding="2">
        <tr><td bgcolor="#FFFF88">
            <a href="<c:url value="/shop/index.do"/>"><b><font color="BLACK" size="2">
              &lt;&lt; Main Menu
            </font></b></a>
        </td></tr>
      </table>
        ...
        <table align="center" bgcolor="#008800" border="0" cellspacing="2" cellpadding="5">
          ...
          <tr bgcolor="#FFFF88">
            ...
            <td align="center">
              ...
              <input type="text" size="3" name="<c:out value="${cartItem.item.itemName}"/>"
            ...
            <td><a href="<c:url value="/shop/removeItemFromCart.do">
              <c:param name="workingItemName" value="${cartItem.item.itemName}"/>
            </c:url>">
      ...
      <c:if test="${cartForm.cart.numberOfItems > 0}">
      <br /><center><a href="<c:url value="/shop/checkout.do"/>">
