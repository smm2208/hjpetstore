  ...
  <TBODY>
    <TR>
      <TD vAlign=top>
        ...
        <P>
        <A href="#SigningUp">Signing Up</A> <BR> <A
          href="#SigningIn">Signing In</A> <BR>
        <A href="#Catalog">Working with the Product Catalog</A> <BR>&nbsp;&nbsp;&nbsp; 
        <A href="#CatalogBrowsing">Browsing the Catalog</A> <BR>&nbsp;&nbsp;&nbsp; 
        <A href="#CatalogSearching">Searching the Catalog</A> <BR><A
          href="#ShoppingCart">Working with the Shopping Cart</A> <BR>&nbsp;&nbsp;&nbsp; 
    ...
    <H2><A name=Issues></A>Known Issues</H2>TBA.</TD></TR>
    <TR>
