...
//
//    public static SecretKey generateRfc2104HmacSha512SecretKey(byte[] plainText) throws NoSuchAlgorithmException, InvalidKeySpecException, UnsupportedEncodingException {
//        // Generate secret key for HMAC-SHA512
//        SecretKeyFactory keyFac = SecretKeyFactory.getInstance("HMAC-SHA-512");
//        SecretKeySpec secretKeySpec = new SecretKeySpec(plainText, HMAC_SHA512_ALGORITHM);
//        SecretKey secretKey = keyFac.generateSecret(secretKeySpec);
//        if (log.isDebugEnabled()) {
//            log.debug(new String(plainText, UTF8) + "'s HmacSHA512 SecretKey: " + secretKey.getEncoded());
//        }
//
//        return secretKey;
//    }
