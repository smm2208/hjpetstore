  ...
  <tr><td valign="top" width="20%" align="left">
      <table align="left" bgcolor="#008800" border="0" cellspacing="2" cellpadding="2">
        <tr><td bgcolor="#FFFF88">
            <a href="<c:url value="/shop/viewCart.do"/>"><b>
              <font color="BLACK" size="2">&lt;&lt; Shopping Cart</font></b></a>
        </td></tr>
      </table>
    </td>
    ...
    <td valign="top" align="center">
      ...
      <table align="center" bgcolor="#008800" border="0" cellspacing="2" cellpadding="5">
        ...
        <tr bgcolor="#cccccc">
          ...
          <td><b>Description</b></td> <td><b>In Stock?</b></td> <td><b>Quantity</b></td>
          <td><b>List Price</b></td> <td><b>Total Cost</b></td>
        </tr>
        ...
        <tr bgcolor="#FFFF88">
          <td><b>
              <a href="<c:url value="/shop/viewItem.do">
                <c:param name="itemName" value="${cartItem.item.itemName}"/>
              </c:url>">
      ...
      <center><html:link page="/shop/newOrderForm.do" transaction="true">
        <img border="0" src="../images/button_continue.gif" />
        </html:link>
      </center>
      <%--
      <center><a href="<c:url value="/shop/newOrderForm.do"/>">
      <img border="0" src="../images/button_continue.gif" /></a></center>
      --%>
    </td>
