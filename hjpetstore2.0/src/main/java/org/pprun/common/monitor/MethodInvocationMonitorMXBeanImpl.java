 ...
 */
@ManagedResource(objectName = "org.pprun.hjpetstore.monitor:name=methodInvocationMonitor", description = "A Monitor Bean store the statistics of the method invocation.")
