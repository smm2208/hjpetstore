 ...
 */
//@Component
public class SpringSslRestClient {

    private static final Logger log = LoggerFactory.getLogger(SpringSslRestClient.class);
    ...
    public <T> T doGet(Class<T> responseType, String acceptMediaType, String acceptCharset, String restUri, Object... uriVariables) {
        ...
        try {
            ...
            response = sslRestTemplate.exchange(restUri,
                    HttpMethod.GET,
                    requestEntity,
                    responseType,
                    uriVariables);
    ...
    public <T> T doPost(Class<T> responseType, String acceptMediaType, String acceptCharset, String restUri, Object... uriVariables) {
        ...
        HttpEntity<T> requestEntity = new HttpEntity(requestHeaders);
        HttpEntity<T> response = sslRestTemplate.exchange(restUri,
                HttpMethod.POST,
                requestEntity,
                responseType,
                uriVariables);
